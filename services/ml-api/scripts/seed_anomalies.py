#!/usr/bin/env python3
"""Seed anomaly_alerts by running detection on all seeded orgs."""
...
async def main() -> None:
    """Fetch all organisations from Supabase and run anomaly detection for each.
        ...
        for org in orgs:
            ...
            try:
                resp = await client.post(
                    f"{base}/analysis/detect-anomalies",
